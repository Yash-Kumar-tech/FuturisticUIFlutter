...
import 'package:shaders_example/common/ticking_builder.dart';
import 'package:shaders_example/common/ui_scaler.dart';
...
class _DifficultyBtns extends StatelessWidget {
  final int difficulty;
  final void Function(int difficulty) onDifficultyPressed;
  final void Function(int? diffuclty) onDifficultyFocused;
